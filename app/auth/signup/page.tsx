      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-400">Join webOS and manage your desktop</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  disabled={loading}
                  className="w-full pl-10 pr-4 py-3 bg-slate-700/50 border border-slate-600/50 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition disabled:opacity-50"
